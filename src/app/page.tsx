              ...
              {activeProjects.map((p, i) => {
                ...
                return (
                  <Link key={p.id} href={`/proyectos/${p.id}`}>
                    <div
                      className="flex items-center gap-4 rounded-[18px] px-4 py-4 border border-black/[0.06] shadow-[0_1px_3px_rgba(19,13,16,0.05)] transition-[box-shadow] hover:shadow-[0_3px_10px_rgba(19,13,16,0.08)]"
